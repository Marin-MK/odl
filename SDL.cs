...
internal class SDL : NativeLibrary
{
    ...
    internal delegate int SDL_IntUInt(uint UInt);
    internal delegate void SDL_VoidVersion(ref SDL_Version Version);
    internal delegate IntPtr SDL_Ptr();
    internal delegate int SDL_IntPtr(IntPtr IntPtr);
    internal delegate int SDL_VoidPtrOutRect(IntPtr IntPtr, out SDL_Rect Rect);
    internal delegate IntPtr SDL_PtrStrIntIntIntIntWindowFlags(IntPtr String, int Int1, int Int2, int Int3, int Int4, SDL_WindowFlags WindowFlags);
    internal delegate IntPtr SDL_PtrPtrIntRendererFlags(IntPtr IntPtr, int Int, SDL_RendererFlags UInt);
    internal delegate IntPtr SDL_UIntPtr(IntPtr IntPtr);
    internal delegate SDL_bool SDL_SDLBoolPtrPtr(IntPtr IntPtr1, IntPtr IntPtr2);
    ...
    internal delegate IntPtr SDL_PtrUIntIntIntIntPixelFormat(uint UInt1, int Int1, int Int2, int Int3, SDL_PixelFormatEnum PixelFormat);
    internal delegate int SDL_IntPtrRectPixelFormatPtrInt(IntPtr IntPtr1, SDL_Rect Rect, SDL_PixelFormatEnum PixelFormat, IntPtr IntPtr2, int Int);
    internal delegate int SDL_IntPtrIntInt(IntPtr IntPtr, int Int1, int Int2);
    internal delegate int SDL_IntPtrFltFlt(IntPtr IntPtr, float Flt1, float Flt2);
    internal delegate int SDL_IntPtrRefRect(IntPtr IntPtr, ref SDL_Rect Rect);
    internal delegate int SDL_IntPtrByte(IntPtr IntPtr, byte Byte);
    internal delegate int SDL_IntPtrPtrRefRectRefRect(IntPtr IntPtr1, IntPtr IntPtr2, ref SDL_Rect Rect1, ref SDL_Rect Rect2);
    internal delegate int SDL_IntPtrPtrRefRectRefRectDblRefPointRendererFlip(IntPtr IntPtr1, IntPtr IntPtr2, ref SDL_Rect Rect1, ref SDL_Rect Rect2, double Dbl, ref SDL_Point Point, SDL_RendererFlip RendererFlip);
    internal delegate SDL_bool SDL_Bool();
    internal delegate IntPtr SDL_PtrSystemCursor(SDL_SystemCursor SystemCursor);
    internal delegate IntPtr SDL_CursorPtrIntInt(IntPtr IntPtr, int Int1, int Int2);
    internal delegate int SDL_IntSDLBool(SDL_bool Bool);
    internal delegate IntPtr SDL_PtrUIntIntIntIntUIntUIntUIntUInt(uint UInt1, int Int1, int Int2, int Int3, uint UInt2, uint UInt3, uint UInt4, uint UInt5);
    internal delegate IntPtr SDL_PtrPtrIntIntIntIntPixelFormat(IntPtr IntPtr, int Int1, int Int2, int Int3, int Int4, SDL_PixelFormatEnum PixelFormat);
    internal delegate int SDL_IntPtrRefRectUInt(IntPtr IntPtr, ref SDL_Rect Rect, uint UInt);
    internal delegate uint SDL_UIntPtrByteByteByteByte(IntPtr IntPtr, byte Byte1, byte Byte2, byte Byte3, byte Byte4);
    internal delegate int SDL_IntPtrRefRectPtrRefRect(IntPtr IntPtr1, ref SDL_Rect Rect1, IntPtr IntPtr2, ref SDL_Rect Rect2);
    internal delegate int SDL_IntPtrBlendMode(IntPtr IntPtr, SDL_BlendMode BlendMode);
    internal delegate int SDL_IntPtrOutBlendMode(IntPtr IntPtr, out SDL_BlendMode BlendMode);
    internal delegate IntPtr SDL_PtrPtrPtr(IntPtr IntPtr1, IntPtr IntPtr2);
    internal delegate int SDL_IntIntOutRect(int Int, out SDL_Rect Rect);
    internal delegate void SDL_VoidUInt(uint UInt);
    internal delegate int SDL_IntOutEvent(out SDL_Event Event);
    internal delegate IntPtr SDL_PtrUInt(uint UInt);
    internal delegate IntPtr SDL_PtrPtr(IntPtr IntPtr);
    internal delegate int SDL_IntPtrOutDisplayMode(IntPtr IntPtr, out SDL_DisplayMode DisplayMode);
    internal delegate int SDL_IntRefMessageBoxDataOutInt(ref SDL_MessageBoxData MessageBoxData, out int Int);
    internal delegate int SDL_IntPtrInt(IntPtr Ptr, int Int);
    ...
    #region Utility
    internal static unsafe string PtrToStr(IntPtr Pointer)
    {
        return System.Runtime.InteropServices.Marshal.PtrToStringAnsi(Pointer);
    }

    internal static unsafe IntPtr StrToPtr(string String)
    {
        return System.Runtime.InteropServices.Marshal.StringToCoTaskMemAnsi(String);
    }

    internal static unsafe string PtrToStrUTF8(IntPtr Pointer)
    {
        return System.Runtime.InteropServices.Marshal.PtrToStringUTF8(Pointer);
    }

    internal static unsafe IntPtr StrUTF8ToPtr(string String)
    {
    ...
    internal static SDL_IntUInt SDL_Init;
    ...
    internal unsafe static IntPtr SDL_CreateWindow(string Title, int X, int Y, int Width, int Height, SDL_WindowFlags Flags)
    {
        return FUNC_SDL_CreateWindow(StrUTF8ToPtr(Title), X, Y, Width, Height, Flags);
    }
    internal static SDL_PtrPtrIntRendererFlags SDL_CreateRenderer;
    ...
    internal static void SDL_SetWindowTitle(IntPtr SDL_Window, string Title)
    {
    ...
    internal static SDL_VoidPtr SDL_DestroyRenderer;
    internal static SDL_VoidPtr SDL_DestroyWindow;
    internal static SDL_PtrUIntIntIntIntPixelFormat SDL_CreateRGBSurfaceWithFormat;
    internal static SDL_IntPtrRectPixelFormatPtrInt SDL_RenderReadPixels;
    internal static SDL_IntPtrIntInt SDL_RenderSetLogicalSize;
    internal static SDL_IntPtrFltFlt SDL_RenderSetScale;
    internal static SDL_IntPtrRefRect SDL_RenderSetViewport;
    internal static SDL_VoidPtr SDL_RenderPresent;
    internal static SDL_IntPtrByte SDL_SetTextureAlphaMod;
    internal static SDL_IntPtrPtrRefRectRefRect SDL_RenderCopy;
    internal static SDL_IntPtrPtrRefRectRefRectDblRefPointRendererFlip SDL_RenderCopyEx;
    internal static Action SDL_StartTextInput;
    internal static Action SDL_StopTextInput;
    internal static SDL_Bool SDL_IsTextInputActive;
    internal static SDL_PtrSystemCursor SDL_CreateSystemCursor;
    internal static SDL_VoidPtr SDL_SetCursor;
    internal static SDL_CursorPtrIntInt SDL_CreateColorCursor;
    internal static SDL_IntSDLBool SDL_CaptureMouse;
    internal static SDL_VoidPtr SDL_FreeSurface;
    internal static SDL_VoidPtr SDL_DestroyTexture;
    internal static SDL_PtrUIntIntIntIntUIntUIntUIntUInt SDL_CreateRGBSurface;
    internal static SDL_PtrPtrIntIntIntIntPixelFormat SDL_CreateRGBSurfaceWithFormatFrom;
    internal static SDL_IntPtrRefRectUInt SDL_FillRect;
    internal static SDL_UIntPtrByteByteByteByte SDL_MapRGBA;
    internal static SDL_IntPtrRefRectPtrRefRect SDL_BlitScaled;
    ...
    internal static SDL_VoidUInt SDL_Delay;
    internal static SDL_IntOutEvent SDL_PollEvent;
    ...
    internal static SDL_IntPtr SDL_LockSurface;
    internal static SDL_IntPtr SDL_UnlockSurface;
    internal static SDL_IntPtrInt SDL_SetSurfaceRLE;
    ...
    internal const uint SDL_INIT_CDROM = 0x00000100;
    internal const uint SDL_INIT_JOYSTICK = 0x00000200;
    internal const uint SDL_INIT_NOPARACHUTE = 0x00100000;
    internal const uint SDL_INIT_EVENTTHREAD = 0x01000000;
    internal const uint SDL_INIT_EVERYTHING = 0x0000FFFF;

    internal const int SDL_WINDOWPOS_UNDEFINED_MASK = 0x1FFF0000;
    internal const int SDL_WINDOWPOS_CENTERED_MASK = 0x2FFF0000;
    internal const int SDL_WINDOWPOS_UNDEFINED = 0x1FFF0000;
    ...
    internal const string SDL_HINT_RENDER_OPENGL_SHADERS = "SDL_RENDER_OPENGL_SHADERS";
    ...
    internal const string SDL_HINT_VIDEO_X11_XVIDMODE = "SDL_VIDEO_X11_XVIDMODE";
    internal const string SDL_HINT_VIDEO_X11_XINERAMA = "SDL_VIDEO_X11_XINERAMA";
    internal const string SDL_HINT_VIDEO_X11_XRANDR = "SDL_VIDEO_X11_XRANDR";
    internal const string SDL_HINT_GRAB_KEYBOARD = "SDL_GRAB_KEYBOARD";
    internal const string SDL_HINT_VIDEO_MINIMIZE_ON_FOCUS_LOSS = "SDL_VIDEO_MINIMIZE_ON_FOCUS_LOSS";
    internal const string SDL_HINT_IDLE_TIMER_DISABLED = "SDL_IOS_IDLE_TIMER_DISABLED";
    internal const string SDL_HINT_ORIENTATIONS = "SDL_IOS_ORIENTATIONS";
    ...
    internal const string SDL_HINT_ALLOW_TOPMOST = "SDL_ALLOW_TOPMOST";
    internal const string SDL_HINT_TIMER_RESOLUTION = "SDL_TIMER_RESOLUTION";
    internal const string SDL_HINT_RENDER_SCALE_QUALITY = "SDL_RENDER_SCALE_QUALITY";
    internal const string SDL_HINT_VIDEO_HIGHDPI_DISABLED = "SDL_VIDEO_HIGHDPI_DISABLED";
    internal const string SDL_HINT_CTRL_CLICK_EMULATE_RIGHT_CLICK = "SDL_CTRL_CLICK_EMULATE_RIGHT_CLICK";
    internal const string SDL_HINT_VIDEO_WIN_D3DCOMPILER = "SDL_VIDEO_WIN_D3DCOMPILER";
    internal const string SDL_HINT_MOUSE_RELATIVE_MODE_WARP = "SDL_MOUSE_RELATIVE_MODE_WARP";
    internal const string SDL_HINT_VIDEO_WINDOW_SHARE_PIXEL_FORMAT = "SDL_VIDEO_WINDOW_SHARE_PIXEL_FORMAT";
    internal const string SDL_HINT_VIDEO_ALLOW_SCREENSAVER = "SDL_VIDEO_ALLOW_SCREENSAVER";
    internal const string SDL_HINT_ACCELEROMETER_AS_JOYSTICK = "SDL_ACCELEROMETER_AS_JOYSTICK";
    internal const string SDL_HINT_VIDEO_MAC_FULLSCREEN_SPACES = "SDL_VIDEO_MAC_FULLSCREEN_SPACES";
    internal const string SDL_HINT_WINRT_PRIVACY_POLICY_URL = "SDL_WINRT_PRIVACY_POLICY_URL";
    internal const string SDL_HINT_WINRT_PRIVACY_POLICY_LABEL = "SDL_WINRT_PRIVACY_POLICY_LABEL";
    internal const string SDL_HINT_WINRT_HANDLE_BACK_BUTTON = "SDL_WINRT_HANDLE_BACK_BUTTON";
    internal const string SDL_HINT_NO_SIGNAL_HANDLERS = "SDL_NO_SIGNAL_HANDLERS";
    internal const string SDL_HINT_IME_INTERNAL_EDITING = "SDL_IME_INTERNAL_EDITING";
    internal const string SDL_HINT_ANDROID_SEPARATE_MOUSE_AND_TOUCH = "SDL_ANDROID_SEPARATE_MOUSE_AND_TOUCH";
    internal const string SDL_HINT_EMSCRIPTEN_KEYBOARD_ELEMENT = "SDL_EMSCRIPTEN_KEYBOARD_ELEMENT";
    internal const string SDL_HINT_THREAD_STACK_SIZE = "SDL_THREAD_STACK_SIZE";
    ...
    internal const string SDL_HINT_WINDOWS_NO_CLOSE_ON_ALT_F4 = "SDL_WINDOWS_NO_CLOSE_ON_ALT_F4";
    internal const string SDL_HINT_XINPUT_USE_OLD_JOYSTICK_MAPPING = "SDL_XINPUT_USE_OLD_JOYSTICK_MAPPING";
    ...
    internal const string SDL_HINT_ANDROID_APK_EXPANSION_MAIN_FILE_VERSION = "SDL_ANDROID_APK_EXPANSION_MAIN_FILE_VERSION";
    internal const string SDL_HINT_ANDROID_APK_EXPANSION_PATCH_FILE_VERSION = "SDL_ANDROID_APK_EXPANSION_PATCH_FILE_VERSION";
    ...
    internal const string SDL_HINT_WINDOWS_DISABLE_THREAD_NAMING = "SDL_WINDOWS_DISABLE_THREAD_NAMING";
    internal const string SDL_HINT_APPLE_TV_REMOTE_ALLOW_ROTATION = "SDL_APPLE_TV_REMOTE_ALLOW_ROTATION";
    internal const string SDL_HINT_AUDIO_RESAMPLING_MODE = "SDL_AUDIO_RESAMPLING_MODE";
    internal const string SDL_HINT_RENDER_LOGICAL_SIZE_MODE = "SDL_RENDER_LOGICAL_SIZE_MODE";
    ...
    internal const string SDL_HINT_JOYSTICK_HIDAPI_PS4_RUMBLE = "SDL_JOYSTICK_HIDAPI_PS4_RUMBLE";
    ...
    internal const string SDL_HINT_ENABLE_STEAM_CONTROLLERS = "SDL_ENABLE_STEAM_CONTROLLERS";
    ...
    internal const string SDL_HINT_RENDER_BATCHING = "SDL_RENDER_BATCHING";
    ...
    internal const string SDL_HINT_VIDO_X11_WINDOW_VISUALID = "SDL_VIDEO_X11_WINDOW_VISUALID";
    internal const string SDL_HINT_GAMECONTROLLER_USE_BUTTON_LABELS = "SDL_GAMECONTROLLER_USE_BUTTON_LABELS";
    internal const string SDL_HINT_VIDEO_EXTERNAL_CONTEXT = "SDL_VIDEO_EXTERNAL_CONTEXT";
    ...
    internal const string SDL_HINT_VIDEO_X11_FORCE_EGL = "SDL_VIDEO_X11_FORCE_EGL";
